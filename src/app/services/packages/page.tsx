...
export const metadata: Metadata = {
  ...
  description:
    'Compare all five Maxwell Software Solutions service packages: Code Health Audit (€2,500), Sprint-in-a-Box (€4,800), Engineering Partner Retainer (€3,500–6,500/mo), CI/CD Accelerator (€7,500), and Fractional CTO (€2,500/mo).',
  openGraph: {
