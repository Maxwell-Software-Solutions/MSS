  ...
  return (
    <footer className="border-t border-black/10 header-glass text-sm text-slate-600 dark:border-white/10 dark:bg-slate-950/80 dark:text-slate-300">
      <div className="mx-auto max-w-6xl px-6 py-12 sm:px-10 sm:py-14">
        {/* Mission statement */}
        <div className="mb-10 pb-8 border-b border-foreground/10">
          <p className="text-lg font-semibold text-foreground/90 max-w-2xl leading-relaxed">
            Building reliable software through code quality audits, testing strategy, and measurable outcomes.
          </p>
        </div>
          ...
          <div className="space-y-6">
            ...
            <dl className="grid gap-4 text-sm sm:grid-cols-2">
              <div className="p-3 rounded-lg bg-accent/5 border border-accent/20">
                <dt className="text-xs font-semibold uppercase tracking-[0.3em] text-[color:var(--accent)]">
                  Email
                </dt>
                <dd>
                  <a
