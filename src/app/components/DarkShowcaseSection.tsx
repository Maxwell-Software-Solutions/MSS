...
export default function DarkShowcaseSection(): ReactElement {
  return (
    <section className="relative neuro-section-border bg-background/50" aria-labelledby="showcase-heading">
      <div
      ...
      <div className="container py-24 sm:py-32 relative">
        <div className="max-w-5xl mx-auto text-center" data-reveal>
          ...
          <p className="mt-6 text-foreground/80 text-lg leading-relaxed max-w-3xl mx-auto">
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-3" data-reveal>
          {[
            ...
            <Card key={f.title} padding="md" className="flex flex-col">
