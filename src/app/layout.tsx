        ...
        <style
          dangerouslySetInnerHTML={{
            ...
            .hero-gradient { background-image: radial-gradient(120% 80% at 50% 0%, rgba(139, 107, 0, 0.12) 0%, rgba(139, 107, 0, 0.06) 30%, transparent 60%); }
              ...
              .menu-toggle { background:none; border:0; color:#000; display:inline-flex; align-items:center; justify-content:center; position:relative; z-index:70; width:2.75rem; height:2.75rem; transition:opacity .2s; }
